  ...
  return (
    ...
    >
      <Container id="train" className={trainStyles.outerWrapper} fluid>
        <Container className={trainStyles.colorLayer} fluid>
                ...
                <Col className={trainStyles.leftColumn} md={12} lg={6}>
                  ...
                  >
                    ...
                    <p className={trainStyles.text}>
                      ...
                      fundamental techniques. Experienced fighters are
                      encouraged to develop their skills further and prepare for
                      upcoming fights. Needless to say, fighting is optional.
                    </p>
                    <p className={trainStyles.text}>
