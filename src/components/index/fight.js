          ...
          <Row>
            ...
            <Col className={fightStyles.rightColumn} md={12} lg={6}>
              ...
              >
                ...
                <p className={fightStyles.text}>
                  Those who wish to step into the ring are more than welcome to
                  do so. We will work together with you to improve your
                  technique and physique so that you get ready.
                </p>
                <p className={fightStyles.text}>
